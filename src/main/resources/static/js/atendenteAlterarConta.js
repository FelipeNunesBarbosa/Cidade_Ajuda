...
function openModalConfirmar() {
    document.getElementById('myModalConfirmar').style.display = 'block';
}

// Função para fechar o modal
function closeModalConfirmar() {
    document.getElementById('myModalConfirmar').style.display = 'none';
}

// Opcional: Fechar o modal clicando fora dele
window.onclick = function(event) {
    var modal = document.getElementById('myModalConfirmar');
